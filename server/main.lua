...
RegisterServerEvent('xua_eilandwinkel:buyItem')
AddEventHandler('xua_eilandwinkel:buyItem', function(itemName, amount, zone)
	local source = source
	...
	if amount < 0 then
		print('xua_eilandwinkel: ' .. xPlayer.identifier .. ' attempted to exploit the shop!')
		return
	end
